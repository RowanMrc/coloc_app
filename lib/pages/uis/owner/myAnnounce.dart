            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context,
                ...
                if (propertiesSnapshot.hasError) {
                  return Text(
                      'Une erreur est survenue : ${propertiesSnapshot.error}');
                }
                ...
                if (propertyIds.length > 0) {
                  return StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance
                        ...
                        .snapshots(),
                    builder: (BuildContext context,
                        AsyncSnapshot<QuerySnapshot> announceSnapshot) {
                      if (announceSnapshot.hasError) {
                        return Text(
                            'Une erreur est survenue : ${announceSnapshot.error}');
                      }
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          final propertyDocument =
                              announceDocument['property_id'].get();
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  children: [
                                                    ...
                                                    Text(
                                                        "${announceData[index]['deposit_amount']}€"),
                                                  ],
                                                ),
                                              ],
                                            ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            TextFormField(
                                                                              ...
                                                                              validator: (value) {
                                                                                if (value!.isEmpty || int.parse(value) < announceData[index]['roomate_number'] || int.parse(value) <= 1) {
